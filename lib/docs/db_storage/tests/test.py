...
# LINK TESTS
    ...
    def test_Cordova(self):
        ...
        content = importer.ProcessContent(entries, importer.getContent('tests/data/test_cordova.html'))
    ...
    def test_DOM_EVENTS(self):
        ...
        content = importer.ProcessContent(entries, importer.getContent('tests/data/test_dom_events.html'))
        print content
